    ...
    <b-container>
      ...
      <b-row>
        <b-col v-for="product in products" :key="product.id">
          <b-card
            :title="product.name"
            :img-src="require(`@/assets/fruit${product.id}.jpg`)"
        ...
        <b-col>
          <b-table bordered hover :items="cart" :fields="fields">
            ...
            <template slot="price" slot-scope="data">
              {{ data.item.price * data.item.quatity }}
            </template>
            ...
            <template slot="image" slot-scope="data">
              <b-img
                ...
                :src="require(`@/assets/fruits${data.item.id}.jpg`)"
                fluid
      ...
      <b-modal
        ...
        ref="modal-1"
        centered
        title="Purches Complete"
      >
        <template slot="modal-footer">
          <b-button variant="info" block class="mt-3" @click="clean">
            Close
          </b-button>
        </template>
    ...
    remove(id) {
      ...
      for (let index = 0; index < this.cart.length; index++) {
        if (this.cart[index].id == id) {
          ...
          console.log("Splice isn't working");
        }
      }
    }, //remove
    buy() {
